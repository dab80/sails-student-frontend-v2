 ...
 *
 * @description :: Server-side logic for managing majors classes
...
var view = "manage_majors_classes";
...
module.exports = {
  ...
  read: function (req, res) {
    ...
    client.get(endpoint, function (data, response) {
        ...
        return res.view(view, {error: { message: "There was an error getting the major_class"}});
    });
