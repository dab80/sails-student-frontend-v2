 ...
 *
 * @description :: Server-side logic for managing students classes
...
var view = "manage_students_classes";
...
module.exports = {
  ...
  read: function (req, res) {
    ...
    client.get(endpoint, function (data, response) {
        ...
        return res.view(view, {error: { message: "There was an error getting the student_class"}});
    });
